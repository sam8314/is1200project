...
void move_bullet(Bullet *b, Player *p)
{
  ...
  if (b->x==61){
    ...
    if (col[(difficultyLevel-1)*4+3][p]==1){
      b->target_hit =1;
        int k = p;
        while(col[(difficultyLevel-1)*4+3][k-1]==1){
            k--;
        }
        while(col[(difficultyLevel-1)*4+3][k]==1){
    ...
    if (col[(difficultyLevel-1)*4+2][p]==1){
      b->target_hit =1;
        int k = p;
        while(col[(difficultyLevel-1)*4+2][k-1]==1){
            k--;
        }
        while(col[(difficultyLevel-1)*4+2][k]==1){
    ...
    if (col[(difficultyLevel-1)*4+1][p]==1){
      b->target_hit =1;
        int k = p;
        while(col[(difficultyLevel-1)*4+1][k-1]==1){
            k--;
        }
        while(col[(difficultyLevel-1)*4+1][k]==1){
    ...
    if (col[(difficultyLevel-1)*4][p]==1){
      b->target_hit =1;
        int k = p;
        while(col[(difficultyLevel-1)*4][k-1]==1){
            k--;
        }
        while(col[(difficultyLevel-1)*4][k]==1){
